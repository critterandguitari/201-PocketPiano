declare filename "sff_formant_model.dsp";
declare name "sff_formant_model";
...
process =  en.adsr(0.01, 0.1, 0.5, rel,gate), pm.SFFormantModelBP(type,vowel,noise,newFreq, 0.1) * gain : *;